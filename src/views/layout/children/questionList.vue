    ...
    <el-card class="table">
      <el-table :data="tableList" border>
        ...
        <el-table-column label="学科.阶段" width="180px">
          <template v-slot="scope">
            <div>{{ scope.row.subject_name }}.{{ stepObj[scope.row.step-1] }}</div>
          </template>
        </el-table-column>
        <el-table-column label="题型" width="120px">
          <template v-slot="scope">
            {{
            typeArr[scope.row.type-1]
            }}
          </template>
        </el-table-column>
        <el-table-column label="企业" prop="enterprise_name" width="190px"></el-table-column>
        <el-table-column label="创建者" prop="username" width="90px"></el-table-column>
